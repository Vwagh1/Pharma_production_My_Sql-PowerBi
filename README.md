...
Performed analysis using joins, CTEs, and window functions
Some sample topics I covered:
Which batches failed and why,
Machine downtime vs yield,
...
Yield and cost insights
Defective products
Machine-wise performance
QC defect type distribution
Monthly trends
I have added the .pbix file in the Power BI folder.
...
Certain defect types occur more often with specific products.
Temperature and pressure variations strongly influence batch rejection.
...
This project helped me understand how a real pharma production and QC process can be analyzed using SQL and Power BI.
I will continue improving it as I learn more.

Feel free to check the SQL file and dashboard!


Project is not fully completed yet; I’m actively working on improving it.
